...
if (isset($_POST["delete"])) {
    ...
    $sql = "DELETE FROM Produit WHERE Reference=$_POST[id]";
...
<fieldset style='float: left'>
    ...
    <table>
        ...
        <tr><td><input name='update' type='submit' value='Update'></td><td><input type='submit' name='delete' value='Delete'></td></tr>
        </table>    
    </form>
</fieldset>
